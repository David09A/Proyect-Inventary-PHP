...
<body>
	<div class="contain1">
		...
		<div class="crear_prod">
			...
			<form action="crear_prov.php" method="POST">
				<h3>Nit:</h3>
					<input type="text" name="k_identi" class="entrada" placeholder="Ingrese nit de la empresa" required>
				<br>
				<h3>Nombre:</h3>
				<input type="text" name="n_name" class="entrada" placeholder="Ingrese Nombre de la empresa" required>
				<br>
				...
				<h3>Correo electronico:</h3>
					<input type="mail" name="n_mail" class="entrada" placeholder="Ingrese correo electronico" required>
				<br>
	...
	//insertar datos en la base de datos
			$insertar = "INSERT INTO gr002det_user (k_identi, n_name, v_phone, n_address, n_mail, k_rol) values 
			('$k_identi', '$n_name', '$v_phone', '$n_address', '$n_mail', '$k_rol')";
