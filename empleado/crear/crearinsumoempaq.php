...
<body>
	<div class="contain1">
		...
		<div class="crear_prod">
			<h2>Crear Insumo</h2>
			<form action="crearinsumoempaq.php" method="POST">
				<h3>Nombre de Empaque:</h3>
				<input type="text" name="nom_empaque" class="entrada" placeholder="Ingrese Nombre del producto" required>
				<br>
				<h3>Cantidad:</h3>
			...
			// En esta sección estamos llenando el select con datos extraidos de una base de datos.
				...
				<br><br>				<input type="submit" value="Registrar" id="boton" name="insert"><br><br>
			</form>
	...
	//insertar datos en la base de datos
			$insertar = "INSERT INTO insumos_para_empacar (nom_empaque, cantidad, ubicacion, nit_proveedor) VALUES ('$nom_empaque', '$cantidad', ' $ubicacion', '$nit_proveedor')";
