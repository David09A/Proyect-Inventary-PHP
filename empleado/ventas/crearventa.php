					...
					if($_GET["status"] === "1"){
						?>
							<div class="alertas">
								...
								$idvt = $_GET['idvent'];
								echo $idvt; ?>
								<a href="verventa2.php?idvt=<?php echo $idvt ?>"target="_blank"><button class=""><i class="fas fa-file-download"></i>Ver Factura</button></a>
							</div>
						<?php
				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a class="boton_tablas" href="<?php echo "aumentarDelCarrito.php?indice=" . $indice?>"><i class="fas fa-plus"></i></a>
								<a class="boton_tablas" href="<?php echo "restarDelCarrito.php?indice=" . $indice?>"><i class="fas fa-minus"></i></a>
								<a class="boton_tablas" href="<?php echo "quitarDelCarrito.php?indice=" . $indice?>"><i class="fas fa-trash-alt"></i></a>
							</td>
						</tr>
						<?php } ?>
					</tbody>
