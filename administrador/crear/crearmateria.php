...
<body>
	<div class="contain1">
		...
		<div class="crear_prod">
			...
			<form action="crearmateria.php" method="POST">
				...
				<input type="text" name="nom_materia_prima" class="entrada" placeholder="Ingrese Nombre del producto" required>
				<br>
				<h3>Cantidad:</h3>
	...
	//insertar datos en la base de datos
			$insertar = "INSERT INTO materia_prima (nom_materia_prima, cantidad, ubicacion, nit_proveedor) VALUES ('$nom_materia_prima', '$cantidad', ' $ubicacion', '$nit_proveedor')";
