...
$pdf->Cell(5,$textypos,"");
        ...
        while($row = $resul ->fetch_assoc()) {       
            ...
            $pdf->SetXY(145, $y);
            $pdf->MultiCell(27, 6, "$ ".number_format($row['precio_venta']), 1, 'C');
            $pdf->SetXY(172, $y);
            $pdf->MultiCell(27, 6, "$ ".number_format($row['total_prod_cant']), 1, 'C');      
        }
        $pdf->Ln();
        $pdf->Ln();
        $pdf->Ln();
        ...
        $pdf->SetXY(172, $y+20);
        $pdf->MultiCell(27, 8, "$ ".number_format($row4['valor_total']), 1, 'C');
