...
<body>
	<div class="contain1">
		...
		<div class="products-list">
			<div class="header">
			<h1>Insumos de Produccion</h1>
			<a href="../../Pdf/reporte_insumosprod.PHP" target="_blank"><button class="generador">Generar PDF</button></a>
			</div>
			<table>
				<tr class="strong">
					<td>Cod.</td>
				...
				$query ="SELECT * from insumos_para_produccion";
				...
				?>
				<tr>
					<td><?php echo $mostrar['id_produc']; ?></td>
					<td><?php echo $mostrar['nom_produccion']; ?></td>
					<td><?php echo $mostrar['cantidad']; ?></td>
					<td><?php echo $mostrar['ubicacion']; ?></td>
					<td><?php echo $mostrar['nit_proveedor']; ?></td>
					<td><a href="ACTUALIZAR/actu_producc.php?inspro=<?php echo $mostrar['nom_produccion']?>"><input type="button" name="Editar" value="Editar" class="boton_tablas"></a></td>
					<td><a href="ELIMINAR/eliminarinsumoprod.php?inspro=<?php echo $mostrar['id_produc']?>"><input type="button" name="eliminar" value="Eliminar" class="boton_tablas"></a></td>
				</tr>
				<?php 
				}
				 ?>
