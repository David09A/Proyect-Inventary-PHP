...
<body>
	<div class="contain1">
		...
		error_reporting(E_ERROR | E_PARSE);
			...
			$ini = $_POST['empaque_ini'];

			$actualizar = "UPDATE `insumos_para_empacar` SET `nom_empaque` = '$nom_empaque', `cantidad` = $cantidad, `ubicacion` = ' $ubicacion', `nit_proveedor` = '$nit_proveedor' WHERE `insumos_para_empacar`.`id_empa` = $ini";
			...
			else
			{
				...
				?>
				<a href="../list_insumoempaq.php" style="color: #fff;"><h2>Volver</h2></a>
				<?php
			}
