...
<body>
	<div class="contain1">
		...
		<div class="crear_prod">
			<h2>Actualizar Empaquetado</h2>
			<?php
			$insemp = $_GET['insemp'];

			$consultar = "SELECT * from insumos_para_empacar where nom_empaque = '$insemp'";
			$resultado = mysqli_query($con, $consultar);
			$mostrar = mysqli_fetch_array($resultado);
			?>
			<form action="actu_empaque.php" method="POST">
				<h3>Nombre de Empaque:</h3>
				<input  value="<?php echo $mostrar['nom_empaque'];?>" type="text" name="nom_empaque" class="entrada" placeholder="Ingrese Nombre del producto" required>
				<br>
				<h3>Cantidad:</h3>
				...
				<br><br>
				<input type="hidden" name="empaque_ini" value="<?php echo $mostrar['id_empa'];?>">
