...
<body>
	<div class="contain1">
		...
		error_reporting(E_ERROR | E_PARSE);
			...
			$actualizar = "UPDATE `materia_prima` SET `nom_materia_prima` = '$nom_materia_prima', `cantidad` = $cantidad, `ubicacion` = ' $ubicacion', `nit_proveedor` = '$nit_proveedor' WHERE `insumos_para_empacar`.`id_empa` = $ini";
			...
			else
			{
				...
				?>
				<a href="../list_materia.php" style="color: #fff;"><h2>Volver</h2></a>
				<?php
			}
