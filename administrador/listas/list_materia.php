		...
		<div class="products-list">
			...
			<table>
				...
				<tr>
					...
					<td><a href="ACTUALIZAR/materia.php?matpri=<?php echo $mostrar['nom_materia_prima']?>"><input type="button" name="Editar" value="Editar" class="boton_tablas"></a></td>
					<td><a href="ELIMINAR/eliminarmateria.php?matpri=<?php echo $mostrar['id_mat']?>"><input type="button" name="eliminar" value="Eliminar" class="boton_tablas"></a></td>
				</tr>
				<?php 
				}
				 ?>
